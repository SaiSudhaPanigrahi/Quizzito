...
error_reporting(E_ERROR | E_WARNING | E_PARSE); //for contest it was showing notices because users class is always there and variables are not passed.
...
//echo $attempt; 
 ...
 <!-- FOR CORRECT Answer IT IS SHOWING ANSWER FOR ALL QUESTIONS.
 <div  class ="col-sm-2"></div>
<div class="col-sm-8">
